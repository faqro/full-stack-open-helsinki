...
describe('total likes', () => {
    ...
    test('when list has many blogs, calculates the sum of likes', () => {
...
describe('author with most blogs', () => {
    ...
    test('when list has one blog, equals to that authors blog', () => {
        const result = listHelper.mostBlogs(listWithOneBlog)
        expect(result).toEqual({author: listWithOneBlog[0].author, blogs: 1})
    })
    test('when list has many blogs, equals to author with most blogs', () => {
...
describe('author with most likes', () => {
    ...
    test('when list has one blog, equals to that authors blog likes', () => {
